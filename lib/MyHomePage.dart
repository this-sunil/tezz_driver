...
import 'package:tezz_driver_app/Pages/service/SearchWidget.dart';
...
class _MyHomePageState extends State<MyHomePage> {
 ...
 late AssignOrderPage assignOrderPage;
 late OrderHistoryPage orderHistoryPage;
  ...
  void initState() {
    ...
    setState(() {
      ...
      assignOrderPage=AssignOrderPage(token: widget.token);
      orderHistoryPage=OrderHistoryPage(token: widget.token);
        ...
        appBar:AppBar(
          actions: <Widget>[
            ...
            setState(() {
              ...
              showSearch(context: context, delegate: SearchWidget(token: widget.token,type: filter));
            });
              //Navigator.push(context, MaterialPageRoute(builder: (context)=>SearchLocation()));
      }, icon: const Icon(Icons.search)),
            IconButton(onPressed: ()=>showFilter(),
