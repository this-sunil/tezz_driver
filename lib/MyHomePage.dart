...
import 'package:tezz_driver_app/Pages/DashboardPage.dart';
...
class _MyHomePageState extends State<MyHomePage> {
 ...
 OrderHistoryPage orderHistoryPage=OrderHistoryPage();
  ...
  void initState() {
    ...
    setState(() {
      storeData();
      dashBoardPage=DashBoardPage(token: widget.token);
      ...
      child: Scaffold(
        ...
        bottomNavigationBar:FancyBottomNavigation(
          ...
          tabs: [
            ...
            TabData(iconData: Icons.local_taxi_sharp, title: "Assigned Order"),
