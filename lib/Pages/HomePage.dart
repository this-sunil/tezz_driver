                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => TripDetailPage(
                                              id: bookingControllerHourly
                                                  .booking[index].data[index].id,token: widget.token,origin: "${bookingControllerHourly.booking[index].data[index].from}",destination: "${bookingControllerOneWay.booking[index].data[index].destination}"),));
                                },
                                child: Card(
                                  elevation: 5,
                                  child: Column(
