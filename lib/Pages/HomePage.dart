                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => TripDetailPage(
                                              ...
                                              id: bookingControllerOneWay
                                                  .booking[index].data[index].id,token: widget.token,origin: "${bookingControllerOneWay.booking[index].data[index].from}",destination: "${bookingControllerOneWay.booking[index].data[index].destination}",)));
                                },
                                child: Card(
                                  elevation: 5,
                                  child: Column(
                                                   ...
                                                   Container(
                                                    ...
                                                    Padding(
                                                     ...
                                                     Padding(
                                                      ...
                                                      child: Text(
                                                        formatDate(DateTime(int.parse("${bookingControllerOneWay.booking[index].data[index].startDate?.substring(0,2)}")),[DD]),
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => TripDetailPage(
                                              id: bookingControllerRound
                                                  .booking[index].data[index].id,token: widget.token,origin: "${bookingControllerRound.booking[index].data[index].from}",destination: "${bookingControllerRound.booking[index].data[index].destination}")));
                                },
                                child: Card(
                                  elevation: 5,
                                  child: Column(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding: const EdgeInsets.all(4.0),
                                                    child: Text(
                                                      "Trip Type : ${bookingControllerRound.booking[index].data[index].rideType}",
                                                    ),
                                                  ),
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => TripDetailPage(
                                              id: bookingControllerHourly
                                                  .booking[index].data[index].id,token: widget.token,origin: "${bookingControllerHourly.booking[index].data[index].from}",destination: "${bookingControllerHourly.booking[index].data[index].destination}"),));
                                },
                                child: Card(
                                  elevation: 5,
                                  child: Column(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.all(4.0),
                                                    child: Text(
                                                      "Trip Type :${bookingControllerHourly.booking[index].data[index].rideType}",
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => TripDetailPage(
                                          ...
                                          id: bookingControllerRound
                                              .booking[index].data[index].id,token: widget.token,origin: "${bookingControllerRound.booking[index].data[index].from}",destination: "${bookingControllerRound.booking.first.data[index].destination}")));
                            },
                            child: Card(
                              elevation: 5,
                              child: Column(
