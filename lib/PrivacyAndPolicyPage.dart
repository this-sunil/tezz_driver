        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                  text:  "This privacy policy sets out how Tezz Taxi uses and protects any information that you give Tezz Taxi when you use this website.\n\nTezz Taxi is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using this website, then you can be assured that it will only be used in accordance with this privacy statement.",
